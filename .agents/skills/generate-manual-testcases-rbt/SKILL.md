...
4. **Validation chuyên biệt từng trường (Field-Level Validation - 15 Field Types):**
   ...
   - Tham chiếu **Bảng Field-Level Validation Checklist** trong skill `$rbt-manual-testing`.
...
- Bảng Test Cases Markdown hoàn chỉnh kèm Automation Metadata (`Automatable`, `Auto Type`, `Tags`), sẵn sàng copy sang Excel/Jira/TestRail
- Traceability Matrix
