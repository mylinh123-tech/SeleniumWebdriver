---
name: "source-command-import-test-results-xray"
description: "Đẩy kết quả test automation (Playwright/JUnit/Allure) lên Xray Test Management."
---

# source-command-import-test-results-xray

Use this skill when the user asks to run the migrated source command `import_test_results_xray`.

## Command Template

# Workflow: Import Test Results to Xray

> **BẮT BUỘC (MANDATORY SKILL):** Bạn PHẢI nạp và đọc kỹ nội dung của skill **`jira_integration`** (tại `.Codex/skills/jira_integration/SKILL.md`) để biết cách sử dụng scripts trước khi bắt đầu.
