...
- `.Codex/rules/locator_strategy.md` — Locator selection priority
- `.Codex/rules/playwright_rules.md` — Playwright-specific rules
- `.Codex/rules/selenium_rules.md` — Selenium-specific rules
- `.Codex/rules/appium_rules.md` — Appium mobile automation rules
