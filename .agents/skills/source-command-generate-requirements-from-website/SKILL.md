---
name: "source-command-generate-requirements-from-website"
description: "Generate Requirements content from a provided website module"
---

# source-command-generate-requirements-from-website

Use this skill when the user asks to run the migrated source command `generate_requirements_from_website`.

## Command Template

# Workflow: Generate Requirements from Website Module

> **BẮT BUỘC (MANDATORY SKILL):** Bạn PHẢI nạp và đọc kỹ nội dung của skill **`requirements_analyzer`** (tại `.Codex/skills/requirements_analyzer/SKILL.md`) để biết định dạng chuẩn của tài liệu Requirements trước khi bắt đầu thực hiện tác vụ này.
