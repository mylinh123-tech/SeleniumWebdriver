---
name: "source-command-analyze-requirement-document"
...
# source-command-analyze-requirement-document

Use this skill when the user asks to run the migrated source command `analyze_requirement_document`.

## Command Template

> **BẮT BUỘC (MANDATORY SKILL):** Bạn PHẢI nạp và đọc kỹ nội dung của skill **`requirements_analyzer`** (tại `.Codex/skills/requirements_analyzer/SKILL.md`) để hiểu cách phân tích yêu cầu chuẩn trước khi bắt đầu.
