---
name: "source-command-generate-locator"
description: "Sinh locator ổn định cho UI element. Hỗ trợ Playwright, Selenium, Appium."
---

# source-command-generate-locator

Use this skill when the user asks to run the migrated source command `generate_locator`.
...
> - **Skill:** `.Codex/skills/smart_locator_agent/SKILL.md` — Quy trình sinh locator
> - **Skill:** `.Codex/skills/ui_debug_agent/SKILL.md` — Quy trình inspect DOM
> - **Rule:** `.Codex/rules/locator_strategy.md` — Bản đồ ưu tiên locator
> - **Rule:** `.Codex/rules/<framework>_rules.md` — Quy tắc riêng framework đang dùng
...
2. **Xác định framework và đọc rules tương ứng:**
   ...
   | Framework | Rule file |
   |-----------|-----------|
   | Playwright | `.Codex/rules/playwright_rules.md` |
   | Selenium | `.Codex/rules/selenium_rules.md` |
   | Appium | `.Codex/rules/appium_rules.md` |
