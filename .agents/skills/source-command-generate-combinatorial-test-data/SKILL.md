---
name: "source-command-generate-combinatorial-test-data"
...
# source-command-generate-combinatorial-test-data

Use this skill when the user asks to run the migrated source command `generate_combinatorial_test_data`.
...
> - **Skill:** `.Codex/skills/test_data_generator/SKILL.md` — Quy tắc sinh data (xem phần Multi-Step Pipeline)
> - **Skill:** `.Codex/skills/ui_debug_agent/SKILL.md` — Inspect DOM khi chạy browser
> - **Workflow:** `.Codex/commands/generate_cross_module_test_plan.md` — Hiểu cấu trúc ma trận đầu vào
