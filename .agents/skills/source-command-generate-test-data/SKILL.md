---
name: "source-command-generate-test-data"
description: "Sinh test data có cấu trúc, unique, traceable cho test cases. Hỗ trợ UI forms, API payloads, data-driven tests."
---

# source-command-generate-test-data

Use this skill when the user asks to run the migrated source command `generate_test_data`.
...
> - **Skill:** `.Codex/skills/test_data_generator/SKILL.md` — Quy tắc sinh data
> - **Rule:** `.Codex/rules/automation_rules.md` — Section Test Data
