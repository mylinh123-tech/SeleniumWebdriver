...
**Fix:** Replace with stable locator following priority in `.Codex/rules/locator_strategy.md`:
...
**Fix:** Use smart waits as defined in `.Codex/rules/selenium_rules.md` and `.Codex/rules/playwright_rules.md`:
```java
// Selenium
...
- `.Codex/rules/locator_strategy.md` — Locator stability rules
- `.Codex/rules/automation_rules.md` — General automation best practices
- `.Codex/rules/selenium_rules.md` — Selenium wait strategy
- `.Codex/rules/playwright_rules.md` — Playwright auto-waiting