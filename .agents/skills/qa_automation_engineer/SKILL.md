...
When the user request matches a specific task, select the appropriate workflow file from `.Codex/commands/`.
...
> **Note:** For detailed locator rules, refer to `.Codex/rules/locator_strategy.md`.

---

# Rules References

The agent MUST also follow the detailed rules defined in `.Codex/rules/`:

- [automation_rules.md](.Codex/rules/automation_rules.md) — General automation best practices
- [locator_strategy.md](.Codex/rules/locator_strategy.md) — Detailed locator selection rules
- [playwright_rules.md](.Codex/rules/playwright_rules.md) — Playwright-specific rules
- [selenium_rules.md](.Codex/rules/selenium_rules.md) — Selenium-specific rules
- [appium_rules.md](.Codex/rules/appium_rules.md) — Appium mobile automation rules
