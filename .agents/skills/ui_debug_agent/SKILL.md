...
- `.Codex/rules/playwright_rules.md` — Playwright browser setup and locator rules
- `.Codex/rules/selenium_rules.md` — Selenium locator and wait rules
- `.Codex/rules/appium_rules.md` — Appium mobile locator rules
