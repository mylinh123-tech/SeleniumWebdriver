---
name: "source-command-generate-automation-from-testcases"
...
# source-command-generate-automation-from-testcases

Use this skill when the user asks to run the migrated source command `generate_automation_from_testcases`.
...
> - **`qa_automation_engineer`** (`.Codex/skills/qa_automation_engineer/SKILL.md`) — Quy tắc automation chung + workflow routing
> - **`ui_debug_agent`** (`.Codex/skills/ui_debug_agent/SKILL.md`) — Inspect DOM, thu thập locators
> - **`smart_locator_agent`** (`.Codex/skills/smart_locator_agent/SKILL.md`) — Sinh locator ổn định
> - **`test_data_generator`** (`.Codex/skills/test_data_generator/SKILL.md`) — Sinh test data unique, traceable
