---
name: "source-command-generate-cross-module-test-plan"
...
# source-command-generate-cross-module-test-plan

Use this skill when the user asks to run the migrated source command `generate_cross_module_test_plan`.
...
> - **Skill:** `.Codex/skills/qa_automation_engineer/SKILL.md` — Workflow routing + automation rules
> - **Skill:** `.Codex/skills/requirements_analyzer/SKILL.md` — Phân tích requirements
