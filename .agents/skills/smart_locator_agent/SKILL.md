...
> **Note:** For detailed rules, refer to `.Codex/rules/locator_strategy.md`.
...
> **Note:** For detailed rules, refer to `.Codex/rules/playwright_rules.md`.
...
> **Note:** For detailed rules, refer to `.Codex/rules/selenium_rules.md`.
...
> **Note:** For detailed rules, refer to `.Codex/rules/appium_rules.md`.
...
- `.Codex/rules/locator_strategy.md` — Master locator priority map
- `.Codex/rules/playwright_rules.md` — Playwright-specific locator rules
- `.Codex/rules/selenium_rules.md` — Selenium-specific locator rules
- `.Codex/rules/appium_rules.md` — Appium-specific locator rules