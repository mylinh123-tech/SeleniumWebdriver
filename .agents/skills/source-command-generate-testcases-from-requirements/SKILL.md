---
name: "source-command-generate-testcases-from-requirements"
description: "Sinh manual test cases nhanh từ requirements (QUICK mode — không qua quy trình 6 bước)."
---

# source-command-generate-testcases-from-requirements

Use this skill when the user asks to run the migrated source command `generate_testcases_from_requirements`.

## Command Template

> **BẮT BUỘC (MANDATORY SKILL):** Bạn PHẢI nạp và đọc kỹ nội dung của skill **`rbt_manual_testing`** (tại `.Codex/skills/rbt_manual_testing/SKILL.md`) trước khi bắt đầu thực hiện tác vụ này. Sử dụng **Mode QUICK** của skill.
