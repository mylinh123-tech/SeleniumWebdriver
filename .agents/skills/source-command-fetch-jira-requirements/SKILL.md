---
name: "source-command-fetch-jira-requirements"
description: "Lấy Requirements / User Stories từ Jira ticket và lưu thành file markdown hoặc JSON."
---

# source-command-fetch-jira-requirements

Use this skill when the user asks to run the migrated source command `fetch_jira_requirements`.
